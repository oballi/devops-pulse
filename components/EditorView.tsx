...
const EditorView: React.FC<EditorViewProps> = ({ user, post, onPublish, onCancel }) => {
    ...
    const handlePublish = async () => {
        ...
        // Slug oluşturma (Basit bir implementasyon, backend'de de var ama burada da olsun)
        ...
        if (post) {
            ...
            const updateResult = await updatePost(post.id, {
                ...
                category: primaryCategory,
                tags: selectedCategories,
                slug: slug // Slug güncelleme opsiyonel olabilir ama başlık değiştiyse güncellensin
            });
            if (updateResult) {
                postId = post.id;
            }
